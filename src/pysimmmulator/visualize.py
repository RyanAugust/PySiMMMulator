...
class Visualize:
    ...
    def plot_spend(self, agg: str = None):
        ...
        plot_cols = self._filter_columns(columns=self.plot_frame.columns.tolist(),
                                         filter_string='_spend')
