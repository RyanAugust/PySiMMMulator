...
def main():
  ...
  arg_parser.add_argument( "-i", "--input-config", action="store", help="Provides configuration file path for simulation",)
  arg_parser.add_argument( "-o", "--output_path", action="store", help="Provides output destination", default=".",)
